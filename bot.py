...
LANGUAGES = {
    ...
    "en": {
        ...
        "check_warning": "⚠️ <b>Suspicious transactions detected</b>\n\n📄 File: <code>{file_name}</code>\n🎁 Gift status: <b>QUESTIONABLE</b>\n⚠️ Refund risk: MEDIUM\n\nRecommendations:\n1. Contact administrator\n2. Use with caution\n3. Monitor activity",
            ...
            with open(LOCK_FILE, 'r') as f:
                ...
                if old_pid.isdigit():
                    try:
                        ...
                        print(f"⚠️ Найден старый процесс с PID {old_pid}")
                    except OSError:
